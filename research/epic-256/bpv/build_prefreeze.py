...
candidate_specs = [
    ...
    ("bo-yango-ventures", "Yango Ventures", "ventures.yango.com", ["BO"], ["yango-bolivia-2025", "yango-official", "yango-launch"], "eligible", "funds/regional/yango-ventures.md", "Dubai-based corporate venture fund with a current USD 20M vehicle, active thesis, founder route and explicit Bolivia launch."),
    ...
    ("ve-epakon", "Epakon Capital", "epakon.com", ["VE"], ["venecapital-map", "epakon-official"], "eligible", "funds/regional/epakon-capital.md", "US-based early-stage fund with explicit LatAm access, a pitch route, 40+ companies and current Venezuelan portfolio activity."),
