...
SOURCES = [
    ...
    source(
        ...
        "Usada somente para datar atividade oficial dentro da janela de corte.",
    ),
    source(
        "sororite-ventures",
...
EVIDENCE = [
    ...
    evidence(
        ...
        "O calendário oficial registra atividade de venture capital em 26 de novembro de 2025, dentro da janela de corte.",
...
UPDATES: dict[str, dict[str, Any]] = {
    ...
    "fund-br-213-quartzo-capital": {
        ...
        "recurring_vc": True,
        "activity_status": "active",
        "latest_official_activity_on": "2025-11-26",
        "status": "decided",
        "decision": "eligible",
        "reason": "Fontes oficiais confirmam identidade, dez veículos de venture capital no Brasil, investimento direto, portfólio, recorrência e atividade datada em 2025.",
        "destination": None,
        "owner": OWNER,
        "next_action": None,
    },
