...
The local project dataset contains 77 companies associated with Darwin Startups. Its most frequent sector labels are Fintech, Exit, Agtech, and its most frequent company countries are Brazil, Global, Latin America. These are observations from an incomplete local collection, not the fund's declared mandate or official portfolio size.
