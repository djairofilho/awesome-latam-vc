...
The local project dataset contains 8 companies associated with Itau Ventures. Its most frequent sector labels are Tecnologia e serviços digitais, and its most frequent company countries are Brazil. These are observations from an incomplete local collection, not the fund's declared mandate or official portfolio size.
