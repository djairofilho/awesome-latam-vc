...
The local project dataset contains 14 companies associated with Krealo. Its most frequent sector labels are Fintech, Payments, Proptech, and its most frequent company countries are Colombia, Chile, Peru. These are observations from an incomplete local collection, not the fund's declared mandate or official portfolio size.
