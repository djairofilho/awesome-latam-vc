...
The reviewed source presents EMA Ventures as investing in Technology and women-led companies across Spanish-speaking Latin America, with entry at Pre-seed and Seed. Details not stated by the fund are marked as not publicly disclosed rather than inferred from portfolio composition.

## Portfolio signals

The local project dataset contains 1 companies associated with EMA Ventures. Its most frequent sector labels are Marketplace / ConstructionTech / Heavy equipment, and its most frequent company countries are Peru. These are observations from an incomplete local collection, not the fund's declared mandate or official portfolio size.
