...
- operate in Latin America or explicitly accept startups from the region;
- offer access to capital, investors, or a structured funding program;
- be active according to a current first-party source;
- include an official website, an application or contact route when available,
  supporting sources, and a verification date;
- remain outside the main fund index unless it operates a qualifying venture
  capital vehicle.
